...
export default function ResumePage() {
  ...
  const handleSubmit = (e) => {
    if (!isFormValid()) {
      ...
      setErrorMessage('Please upload a resume or provide at least one social media link!'); // Set error message
    } else {
  ...
  return (
    <div className="min-h-screen moving-gradient bg-gradient-to-br from-blue-100 via-purple-50 to-pink-100 flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md rounded-lg shadow-lg glassmorphism p-6 space-y-6"> {/* Added glassmorphism class here */}
